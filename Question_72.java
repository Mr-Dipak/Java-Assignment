...
public class Question_72 extends Frame 
  {
    Label l1,l2,l3,l4;
    ...
    Question_72()
    {
        ...
        b1.addActionListener(q72);
        b2.addActionListener(q72);
        b3.addActionListener(q72);
        b4.addActionListener(q72);
        b5.addActionListener(q72);
        b6.addActionListener(q72);
